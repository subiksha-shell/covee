...
class read_profiles:
    ...
    def read_csv(self):
        ...
        cwd = os.getcwd()
        wd = os.path.join(cwd, 'covee/forecast')
        wd.replace("\\", "/")
        with open(os.path.join(wd, 'PV_forecast_June.csv')) as csv_file: #10 Nodes: 10_nodes_PV # No Cloud: PV_profile_LV_SOGNO_4kw  #With Cloud: PV_profile_LV_SOGNO-cloudlevel-2.csv
